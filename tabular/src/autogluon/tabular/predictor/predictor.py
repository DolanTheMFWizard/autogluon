...
class TabularPredictor:
    ...
    **kwargs :
    ...
    def bad_pseudo_fit(self, train_data, test_data, validation_data, fit_kwargs=None,
        ...
        self.fit(train_data=train_data, tuning_data=validation_data, **fit_kwargs)
        best_model = self
            ...
            if len(test_data_pseudo) > 0:
                ...
                if reuse_pred_test:
                    ...
                    unittest.TestCase.assertTrue(
                        np.all(test_data.index == test_pseudo_indices[~test_pseudo_indices].index),
    ...
    def feature_importance(self, data=None, model=None, features=None, feature_stage='original', subsample_size=1000,
                           time_limit=None, num_shuffle_sets=None, include_confidence_band=True, silent=False):
        """
