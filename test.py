...
first_score = predictor.info()['best_model_score_val']
first_best_model = predictor.info()
predictor.pseudo_label_fit(labeled_pseudo_data)
pl_score = predictor.info()['best_model_score_val']

print('First model eval score:')
print(first_score)
print('Pseudo model eval score:')
print(pl_score)